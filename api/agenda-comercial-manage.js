// api/agenda-comercial-manage.js — Ações administrativas do /agenda-comercial-painel:
// apagar, mudar data/horário ou atribuir atendente a um agendamento existente.
// Só mexe na planilha — não toca no DataCrazy.
//
// POST { action: 'delete', id }
// POST { action: 'update', id, date, time }
// POST { action: 'assign', id, atendente }
//
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error('Erro agenda-comercial-manage:', err);
